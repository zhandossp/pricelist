...
<!---LOCAL --->
<script type="text/javascript" src="/profile/files/js/mytables/countries/form.js"></script>
<!------------>
            ...
            <div class="panel-body">
                ...
                <div class = "col-md-12">
                    <div class="text-right">
                        ...
                        <? if ($model->id != null) { ?>
                            <a href = "#delete" data-id = "<?=$model->id?>" data-table = "countries" data-redirect = "countries" class="delete btn btn-danger">Удалить <i class="icon-trash-alt position-right"></i></a>
                        <? } ?>
