...
<!---LOCAL --->
<script type="text/javascript" src="/profile/files/js/mytables/params/form.js"></script>
<!------------>
            ...
            <div class="panel-body">
                ...
                <div class = "col-md-12">
                    <div class="text-right">
                        ...
                        <? if ($model->id != null) { ?>
                            <a href = "#delete" data-id = "<?=$model->id?>" data-table = "params" data-redirect = "params" class="delete btn btn-danger">Удалить <i class="icon-trash-alt position-right"></i></a>
                        <? } ?>
