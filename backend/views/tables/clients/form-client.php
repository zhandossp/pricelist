...
<!---LOCAL --->
<script type="text/javascript" src="/profile/files/js/mytables/clients/form.js"></script>
<!------------>
        ...
        <div class="panel panel-flat">
            <div class="panel-body">
                ...
                <div class="col-md-6">
                    ...
                    <?=$this->render('/layouts/modal-components/_input', array('info' => array("Ф.И.О", "name", "text", $model->name, "true")))?>
                ...
                <div class = "col-md-12">
                    <div class="form-group">
                        ...
                        <? if ($model->ava != null) { ?>
                            <div class="form-group">
                                <img src = "uploads/clients/<?=$model->ava?>" />
                            </div>
                        <? } ?>
                        <input type="file" name = "Clients[image]" accept="image/*" class="file-styled">
                    ...
                    <div class="text-right">
                        ...
                        <? if ($model->id != null) { ?>
                            <a href = "#delete" data-id = "<?=$model->id?>" data-table = "clients" data-redirect = "clients" class="delete btn btn-danger">Удалить <i class="icon-trash-alt position-right"></i></a>
                        <? } ?>
