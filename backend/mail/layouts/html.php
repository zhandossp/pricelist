а<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 13px; color: #333333; text-align:left;line-height: 24px;">
                                                Вы были зарегистрированы как <strong>администратор</strong>.<br/>
                                                <div style = "margin-top:10px;">
                                                    <strong>Ваши данные для входа на сайт:</strong><br/>
                                                    Логин: <? var_dump($email); ?><br/>
                                                    Пароль: <?=$password?>
                                                </div>
                                            </td>
                                        </tr>
